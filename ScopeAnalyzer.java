...
public class ScopeAnalyzer {
        ...
        public String lookup(String name) {
            ...
            for (String key : symbolTable.keySet()) {
                ...
                if (key.contains(name)) {
                    System.out.println("Symbol found: " + key);
                    return key;
                }
            }
    ...
    public FunctionSymbolTable getFunctionTable(){
        return functionTable;
    }

    // public FunctionSymbolEntry lookupFunction(String functionName){
    //     return functionTable.lookupFunction(functionName);
    // } 
